...
myLine = "";
myName = "Relay Node 10123";
myNum = 10; //set this to the ID number of this NPC
...
addLine[0] = "While digging deeper some of miners found what looks like coral. But not petrified coral, live coral.";
addLine[1] = "Which is pretty impossible considering these caves were sealed to the world up until a year ago.";
addLine[2] = "I don't like the formation these polyps are in either. They look like a face.";
