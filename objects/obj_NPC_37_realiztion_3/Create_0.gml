...
myLine = "";
myName = "Log 0252738";
myNum = 37; //set this to the ID number of this NPC
...
addLine[0] = "This entire cave system is the remains of it's old body. Fossilzed and broken off as it delves deeper for warmth.";
