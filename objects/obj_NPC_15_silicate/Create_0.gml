...
myLine = "";
myName = "ID 19461";
myNum = 15; //set this to the ID number of this NPC
...
addLine[0] = "There's some kind of crytal lattice in the water here.";
addLine[1] = "It's not strong but it seems to reform behind me as fast as I can bore through it.";
addLine[2] = "Is it the same stuff as these giant crystals? I swear they're moving."
