...
myLine = "";
myName = "Log Relay 20347";
myNum = 28; //set this to the ID number of this NPC
...
addLine[0] = "I'm seeing things moving in the crystal. A shadow passing through it, but not through the surrounding water.";
addLine[1] = "My oxygen is low.";
