...
myLine = "";
myName = "Log p055un";
myNum = 50; //set this to the ID number of this NPC
...
addLine[0] = "I want to make great things to share with the world.";
addLine[1] = "Yet I can barely even feed myself. Taking this job at the bottom of the ocean.";
addLine[2] = "I hope this gets buried in the crusts of the earth."; 
