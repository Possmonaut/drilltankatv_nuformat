...
myLine = "";
myName = "Signal ’’t9’’’";
myNum = 19; //set this to the ID number of this NPC
...
addLine[0] = "We're too deep to get a radio signal.";
addLine[1] = "We haven't recieved supplies.";
addLine[2] = "Were we too secretive for our own good?";
addLine[3] = "Is the union still there?";
...
myBod.sprite_index = sp_soviet_probe;
