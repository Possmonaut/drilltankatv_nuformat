...
{
oceanAmb = audio_play_sound(amb_crystal,1,true);
audio_sound_gain(oceanAmb,0,0);
}
else
{
	var b = audio_sound_get_track_position(amb_crystal);
...
fg_fungal = layer_background_create(fg_fungal_layer,sp_bg_crystal_lattice);
