...
myLine = "";
myName = "null";
myNum = 49; //set this to the ID number of this NPC
...
addLine[0] = "I thought it was a cadaver at first. Someone lost at sea but somehow managed to sink down here.";
addLine[1] = "Nothing left but a torso and a rotting, mushy head.";
addLine[2] = "Then I realized it's size.";
