...
myNum = 0; //set this to the ID number of this NPC
...
addLine[2] = "Eddie, we've been over this. I know you work near the south magma levee but you need to know when your getting too close.";
addLine[3] = "...";
