...
myLine = "";
myName = "Log Relay 20346";
myNum = 27; //set this to the ID number of this NPC
...
listSz = 2; //set to line number +1

for(var i = 0; i < listSz; i++){addLine[0] = "";}

addLine[0] = "It's not just the supersatured water it grows in. I found one of those swimming things from the upper caverns covered in the stuff.";
addLine[1] = "I ran a scan, and it was like whatever soft tissues this thing had were replaced entirely by crystal.";
addLine[2] = "Boring into it, it broke apart. It bled crystals instead of blood.";
