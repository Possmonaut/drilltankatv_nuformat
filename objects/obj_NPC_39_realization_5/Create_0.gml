...
myLine = "";
myName = "Log 0252741";
myNum = 39; //set this to the ID number of this NPC
...
addLine[0] = "Fungi breed through fruiting bodies. A long stalk that grows upwards from the mycelia. Is that my way out? What happens when it's spores reach the surface.";
