...
myLine = "";
myName = "ID 02674";
myNum = 14; //set this to the ID number of this NPC
...
addLine[0] = "It's starting to get warmer. Both on the temp read out and the cockpit temperature.";
addLine[1] = "We're so deep it's stopped getting cold.";
