...
myLine = "";
myName = "Log Relay 20344";
myNum = 25; //set this to the ID number of this NPC
...
addLine[0] = "I've broken through a few lattices of the stuff, barricading the tunnel walls like a spider web.";
