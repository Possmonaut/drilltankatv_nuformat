...
myLine = "";
myName = "Log 0252734";
myNum = 33; //set this to the ID number of this NPC
...
addLine[0] = "I saw another one of those tapeworm things encased in crystal."; 
addLine[1] = "Now, some machinery, moving around on it's own, encased in some sort of flesh.";
addline[2] = "I think each of these caverns have been isolated from one another.";
addLine[3] = "And now we're opening them up to each other.";
