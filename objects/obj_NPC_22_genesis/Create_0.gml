...
myLine = "";
myName = "Signal ’’’7’’";
myNum = 22; //set this to the ID number of this NPC
...
listSz = 3; //set to line number +1

for(var i = 0; i < listSz; i++){addLine[0] = "";}

addLine[0] = "Panspermia. The theory that life on earth was seeded from some comet aeons ago.";
addLine[1] = "Some alien lichen, charred to a crisp, it's rotting body seeding an entire world.";
addLine[2] = "Maybe we can do the same to this cavern. Our remains blooming life into the dark.";
addLine[3] = "Dreaming entire worlds in our endless sleep.";
