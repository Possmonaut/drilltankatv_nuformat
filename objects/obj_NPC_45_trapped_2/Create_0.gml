...
myLine = "";
myName = "Relay 104104";
myNum = 45; //set this to the ID number of this NPC
...
addLine[0] = "These things are supposed to be self sufficient for days. Weeks even.";
addLine[1] = "And with a nuclear reactor powering it, they can probably outlast their pilots.";
