...
myLine = "";
myName = "Signal ’’’’i’";
myNum = 20; //set this to the ID number of this NPC
...
addLine[0] = "The tank containing gene mix 12 ruptured and has leaked into the surrounding caverns.";
addLine[1] = "With no supplies since August, I might soon join it in the dark.";
