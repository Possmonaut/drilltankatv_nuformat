...
myLine = "";
myName = "Log Relay 20345";
myNum = 26; //set this to the ID number of this NPC
...
addLine[0] = "I think barricade was the right word. I hit a dead end and turned around, only to find my way blocked by another crystal lattice.";
