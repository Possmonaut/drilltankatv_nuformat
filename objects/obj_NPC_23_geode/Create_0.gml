...
myLine = "";
myName = "Log Relay 20342";
myNum = 23; //set this to the ID number of this NPC
...
addLine[0] = "Wish the tunnel hadn't collapsed and dropped me down here. There's minerals in here worth millions."
addLine[1] = "I think this entire cavern is just one big geode."
addLine[2] = "Too bad we get paid hourly."
