...
endCellGen = 25; //basically the length of each of the update box' sides, centered on the player
...
arrayMax = 8; //used to prevent out of bounds errors
