...
myLine = "";
myName = "Relay 119474";
myNum = 46; //set this to the ID number of this NPC
...
addLine[0] = "You wake up in your cramped aft cabin, basically a small divot in the hull. It's dark. The air is humid and stale.";
addLine[1] = "You slide into the driver's seat, eat your rations, report in, and start to dig.";
addLine[2] = "It's nearly a month of decompression if you want to go back to the surface, and the job's not done. So...";
addLine[3] = "Nothin' to do but stare at the rock, or the endless abyssal void. gets to you sometimes.";
