...
myLine = "";
myName = "Relay 58816";
myNum = 48; //set this to the ID number of this NPC
...
listSz = 5; //set to line number +1

for(var i = 0; i < listSz; i++){addLine[0] = "";}

addLine[0] = "Depot Automat 4 polling surface relay T1275";
addLine[1] = "...";
addLine[2] = "...";
addLine[3] = "Depot Automat 4 polling surface relay T1275";
addLine[4] = "...";
addLine[5] = "...";
...
myBod.sprite_index = sp_npc_crystal;
