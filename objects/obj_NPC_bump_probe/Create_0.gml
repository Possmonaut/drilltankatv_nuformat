...
myLine = "";
myName = "T Relay 01078";
myNum = 3; //set this to the ID number of this NPC
...
addLine[0] = "Ed's probe isn't transmitting again? Tell him to just bump his tank into it. Should work."
