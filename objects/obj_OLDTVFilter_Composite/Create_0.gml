...
if(variable_global_exists("oldtvfilter_enabled"))
{
	instance_destroy();
	exit;
}
...
global.noise_magnetude = -0.4;              //  -1.0 ~ 1.0 //was -0.2
global.static_pattern = sprite_get_texture(sprStatic1,0);
global.static_magnetude = 0.05;              //  0.0 ~ 1.0 //changed from 0, 11/11
global.static_scale = 0.00001; //this doesn't seem to do anything 
global.static_offset = 0; // 0.0 ~ 1.0
global.dirt_pattern = sprite_get_texture(sprNoise1,0);
global.dirt_magnetude = 0.1;                //  0.0 ~ 1.0 //changed from 0, 11/11
