...
addLine[0] = "...Feed strength low. Please connect directly to probe..";
addLine[1] = "Rich mineral vein located 576 meters southeast. Proceed around.";
...
myBod = instance_create_depth(x+16,y+16,depth-1,obj_ow_generic);
