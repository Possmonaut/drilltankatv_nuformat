...
myLine = "";
myName = "Signal ’’’’’";
myNum = 21; //set this to the ID number of this NPC
...
addLine[0] = "Our subterrene is unable to carry us to the surface without a refueling.";
addLine[1] = "I fear that whatever has happened up above, we are to be forgotten casualties, down here in the dark.";
