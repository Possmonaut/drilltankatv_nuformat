...
myLine = "";
myName = "ID TRS19469";
myNum = 09; //set this to the ID number of this NPC
...
listSz = 2; //size + 1 if single line

for(var i = 0; i < listSz; i++){addLine[0] = "";}

addLine[0] = "I can't find an exit no matter where I look. This cave system is surrounded by molten rock on every side.";
addLine[1] = "I think the only way I'm going to get out is to follow the natural cavern itself.";
addLine[2] = "But the only way it's going is deeper.";
