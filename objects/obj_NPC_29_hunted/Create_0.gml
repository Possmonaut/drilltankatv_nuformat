...
myLine = "";
myName = "Log Relay 20348";
myNum = 29; //set this to the ID number of this NPC
...
addLine[0] = "Whatever I'm seeing isn't it. I think the crystal is a feeding mechanism.";
addLine[1] = "It's predatory.";
