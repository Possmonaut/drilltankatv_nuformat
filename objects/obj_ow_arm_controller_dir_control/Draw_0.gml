...
lArm.image_alpha = progen.activeDraw;

rArm.endpointX = armPnt2X;
rArm.endpointY = armPnt2Y;
rArm.image_alpha = progen.activeDraw;
...
for(var i = 0; i <5; i ++)
{
	...
	segArray[i+1].image_alpha = progen.activeDraw;
}

draw_sprite_ext(myBod,atkIndex,x,y,1,1,cDur-90,c_white,progen.activeDraw);
