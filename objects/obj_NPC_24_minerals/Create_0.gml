...
myLine = "";
myName = "Log Relay 20343";
myNum = 24; //set this to the ID number of this NPC
...
addLine[0] = "It looks like quartz but it's not. Some kind of silicate isotope? The stuff resonates even as I pass it, like it's following me.";
