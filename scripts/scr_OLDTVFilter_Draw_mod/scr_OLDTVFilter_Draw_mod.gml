function scr_OLDTVFilter_Draw_mod() {
	//
	...
	//  Surface Size
	var window_width  = obj_ow_camera.view_width;
	var window_height = obj_ow_camera.view_height;
	var surface_width = 1157;
	var surface_height = 985;
	...
	if( global.oldtvfilter_enabled ) {
	    ...
	    //  Draw
	    draw_surface_stretched(global.bufferSurface[!surfaceFlag],380,120, surface_width, surface_height); //modified 2/23/2020
	    draw_surface_stretched(global.bufferSurface[!surfaceFlag],380,120, surface_get_width(global.bufferSurface[!surfaceFlag]), surface_get_height(global.bufferSurface[!surfaceFlag]));
	    draw_surface_stretched(global.bufferSurface[!surfaceFlag],380,120, surface_get_width(application_surface), surface_get_height(application_surface));
	    draw_surface_stretched(global.bufferSurface[!surfaceFlag],380,120, surface_width, surface_height);
	} else {
	    draw_surface_stretched(application_surface, 380, 75, surface_width, surface_height);
	}
