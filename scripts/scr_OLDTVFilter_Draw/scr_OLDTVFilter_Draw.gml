function scr_OLDTVFilter_Draw() {
	...
	//  Surface Size
	var window_width  = 1197;
	var window_height = 985; //window_get_height;
	//original; 1157, 985; 2.0: 1197,985

	var surface_width = 1197;
	var surface_height = 985; //surface_get_height(application_surface);
	//original; 1157,985
	...
	//	}
	    ...
	    draw_surface(application_surface, -362, -62); //was -365, -66
	    ...
	    //  Draw
	    draw_surface(global.bufferSurface[!surfaceFlag], 365, 65); //modified 2/23/2020
	    draw_surface(global.bufferSurface[!surfaceFlag], 365, 65);
	    draw_surface(global.bufferSurface[!surfaceFlag], 365, 65);
	    draw_surface(global.bufferSurface[!surfaceFlag], 365, 65);
	} else {
	    draw_surface(application_surface, -362, -62);
	}
